    ...
    return () => {
        ...
        subscription.unsubscribe(); // clean up the subscription
            ...
            <p>
                ...
                For these types of effects, React provides one additional Hook called <span className="link-success" role="button" onClick={handleLinkToUseLayoutEffect}>useLayoutEffect</span>.
